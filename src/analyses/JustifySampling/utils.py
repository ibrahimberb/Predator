...
#
#
# def get_corr_values(query, verbose=False):
#     corr_score_values = []
...
#         """
#
#         print(f"Exporting data {file_name} ..")
...
#         else:
#             # Export
#             self.unique_pairs_corr_data.to_csv(file_name, index=False)
#             print(f'{file_name} is exported successfully.')
